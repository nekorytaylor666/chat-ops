...
export function DataGridColumnHeader<TData, TValue>({
  ...
  const onTriggerPointerDown = React.useCallback(
    (event: React.PointerEvent<HTMLButtonElement>) => {
      ...
      // Defer the column click to avoid interfering with Radix dropdown opening
      // The state update from onColumnClick can cause a re-render that closes the dropdown
      queueMicrotask(() => {
